...
class TestParser(unittest.TestCase):
    def test_should_parse_valid_file_with_one_line(self):
        # given
        input_file = TEST_DATA_PATH + os.sep + "input_one_row_valid.txt"
        # when
    ...
    def test_should_parse_valid_file_with_tree_line(self):
        # given
        input_file = TEST_DATA_PATH + os.sep + "input_tree_row_valid.txt"
        # when
        result = parser.parse_file(input_file)
        # then
    ...
    def test_should_parse_file_with_empty_places(self):
        # given
        input_file = TEST_DATA_PATH + os.sep + "file_with_empty_places.txt"
        # when
        result = parser.parse_file(input_file)
        # then
